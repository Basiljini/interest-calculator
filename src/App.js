        ...
        <div style={{width:'600px'}} className='bg-light p-5 rounded'>
          <h1>Simple Interest Calculator</h1>
            ...
            
            {
              ...
              <Button type='submit' style={{height:'70px', width:'250px'}} variant="contained" className='bg-dark'disabled={validPrinciple&&validRate&&validYear?false:true}>CALCULATE</Button>
              <Button onClick={handleReset} style={{height:'70px', width:'250px',color:'black'}} variant="outlined" className='text-dark'>RESET</Button>
             </Stack>
             </form>
